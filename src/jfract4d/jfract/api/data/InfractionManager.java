...
public interface InfractionManager {
     ...
     * All infraction types going by that category will be moved to the UNDEFINED category
     * @param name 
     */
    ...
    /**
     * Updates the infraction type going by the name given from the updateIType passed
     * @param name
     * @param updatedIType 
     */
    ...
    /**
     * Removes an infraction type
     * this will cause every infraction going by that type to UNDEFINED
     * @param name 
     */
   ...
   /* INFRACTIONS */
    ...
    /**
     * Removes an infraction by its ID
     * This will remove every trace of that infraction ever being given
     * If you want to pardon a user but keep the infraction record, see {@link InfractionManager#updateInfractionEffective(java.lang.String, boolean)}
     * @param id 
     */
